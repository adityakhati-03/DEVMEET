  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '12px', width: '100%' }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', margin: '16px 0', width: '100%' }}>
        ...
        <span style={{ padding: '0 12px', color: 'var(--dm-muted)', fontFamily: '"JetBrains Mono", monospace', fontSize: '13px', textTransform: 'uppercase', fontWeight: 700 }}>Or continue with email</span>
        <div style={{ flex: 1, height: '2px', background: 'var(--dm-border)' }} />
      </div>
    </div>
  );
